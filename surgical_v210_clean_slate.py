...
def surgical_v210_clean_slate(output_path):
    # 1. Source (Newest Green Screen)
    ...
    # Clamp G to max(R, B) to remove green halo
    new_g = np.minimum(new_g, max_rb)
    
    # 4. ORANGE KILLER (Standard Polish)
    ...
    print(f"Surgical V210 Clean Slate Complete: {output_path}")

surgical_v210_clean_slate("public/assets/water_deity_unit_final.png")
