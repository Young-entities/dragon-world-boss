...
def surgical_v212_left_crop(output_path):
    # 1. Source (Screenshot)
    search_pattern = "../*.png"
    ...
    # 3. LEFT CROP (The Fix)
    # User screenshot shows a vertical artifact line on the left.
    # We crop the left 15% to be safe (Spear doesn't touch edge).
    crop_zone = int(w * 0.15)
    alpha[:, :crop_zone] = 0
    ...
    print(f"Surgical V212 Left Crop Complete: {output_path}")

surgical_v212_left_crop("public/assets/water_deity_unit_final.png")
