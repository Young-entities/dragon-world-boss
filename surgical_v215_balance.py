...
def surgical_v215_balance(output_path):
    # 1. Source (Screenshot)
    search_pattern = "../*.png"
    ...
    # 3. BALANCED CROP (The Fix)
    # Right Side: Dragon touches edge. NO CROP.
    # Left Side: Artifact line exists. Spear is safe. CROP 20px.
    ...
    print(f"Surgical V215 Balance Complete: {output_path}")

surgical_v215_balance("public/assets/water_deity_unit_final.png")
